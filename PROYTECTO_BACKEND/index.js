...
const AnimalRoutes = require("./src/api/routes/Animal.routes");
const { create } = require("./src/api/models/Shelter.model");
app.use("/api/v1/animals/", AnimalRoutes)

const ShelterRoutes = require("./src/api/routes/Shelter.routes");
